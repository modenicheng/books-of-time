...
5. [~] P1 Collection-First Snapshot Cohorts：C1 Evidence Foundations 与 C2 Cohort State And Policy 已完成，下一阶段执行 C3 Persistent Planner And Shadow Mode，随后按 C4-C9 分阶段验收。
